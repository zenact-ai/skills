...
- **[product-grill-me](./skills/engineering/product-grill-me/SKILL.md)** — Grill one product scenario through its implementation, supplying the product, technical, priority, and existing-code-pattern context behind every decision.
